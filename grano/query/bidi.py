...
CREATE MATERIALIZED VIEW grano_relation_bidi
    (created_at, updated_at, id, relation_id, schema_id, source_id, target_id,
        author_id, project_id, reverse)
        AS
        SELECT created_at, updated_at, id AS id, id AS relation_id, schema_id,
